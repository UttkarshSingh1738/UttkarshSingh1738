    ...
    public Management(String para){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int id = rs.getInt("id");
                if (id == ID){
                    jLabel4.setText("Welcome, " + name); break;}
...
//            JOptionPane.showMessageDialog(null, "Cannot connect to the database. Please Setup the database and try again ");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Management Dashboard");

        jLabel4.setFont(new java.awt.Font("Sylfaen", 1, 12)); // NOI18N
        jLabel4.setText("Welcome");

        jButton1.setText("New Student Enrollment");
        ...
        jButton2.setText("Student Reports");
        ...
        jButton3.setText("Credential Dictionary");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        setContentPane (new Credential());
        pack();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        setContentPane (new New_Student_Enrollment());
        pack();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        setContentPane (new Student_Reports());
        pack();
