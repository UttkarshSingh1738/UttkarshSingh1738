...
//            JOptionPane.showMessageDialog(null, "Cannot connect to the database. Please Setup the database and try again ");
    ...
    private void initComponents() {
        ...
        jButton3.setText("Class View/Management");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        new Tutor_Dash_2(jLabel6.getText()).setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        setContentPane (new Inventory());
        pack();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new Tutor_Comm(jLabel6.getText()).setVisible(true);
