 ...
 * @author uttka
 */
public class Management_Login extends javax.swing.JPanel {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (input_u.equals(user) && input_p.equals(pass)){
                    ...
                    there = 1; manager = 0; break; }
                        
                else 
                    there = 0; manager = 0; } 
            if (there == 1 && manager == 1){
                frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
                new Management(ID).setVisible(true);

            }                
            else if(there == 1 && manager ==0){    
                JOptionPane.showMessageDialog(frame, "You are not a Manager!");}
            else if (there ==0){
